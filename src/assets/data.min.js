...
const data = {
	...
	Home: {
		introduction:
            ...
            "What a beatiful world! I love code, and I will love you forever!",

		resumeLink: "1-5xF-wKz9eO06kv3lj0ZFEBFafyChmag",
		typedElement: [
			"Hito Yamaitachi",
	...
	About: {
		...
		NavTabs: [
			...
			{ id: "career", name: "Career", placement: "top" }
		],
		about: {
			"tech-stats":
		...
		career: [
			...
			},
            {
				...
				reviewCount: "88",
				totalearning: "$50K +",
				role: "Database manager & Backend Developer & Frontend Developer",
				duration: "2019 - 2024",
				completedTask: "99",
				achievments: [],
			},
	...
	Social: [
		[
			{
				link: "https://github.com/HitoYamaitachi",
				class: "fab fa-github",
				name: "GitHub",
				placement: "left",
			},
